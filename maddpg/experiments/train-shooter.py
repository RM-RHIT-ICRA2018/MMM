...
from maddpg.trainer.maddpg_2 import MADDPGAgentTrainer
import tensorflow.contrib.layers as layers

def parse_args():
    parser = argparse.ArgumentParser("Reinforcement Learning experiments for multiagent environments")
    # Environment
    parser.add_argument("--scenario", type=str, default="simple_tag-bac_5", help="name of the scenario script")
...
def get_trainers(env, num_adversaries, obs_shape_n, arglist):
    ...
    for i in range(num_adversaries):
        trainers.append(trainer(
            env, "agent_%d" % i, model, obs_shape_n, env.action_space, i, arglist,
